...
import { auth, createUserProfileDocument } from '@firebaseDir'
      ...
      <div className="sign-in">
        ...
        <form className="sign-up-form" onSubmit={handleSubmit}>
          ...
          <FormInput
            ...
            handleChange={handleChange}
            label={
              FORM_TYPE.PASSWORD.charAt(0).toUpperCase() +
              FORM_TYPE.PASSWORD.slice(1)
            }
            required
          />
          <FormInput
            ...
            required
          />
          <CustomButton type="submit">{LINKS_TEXT.SIGN_UP}</CustomButton>
        </form>
      </div>
      <img
